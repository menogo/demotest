    ...
    <div class="page">
      ...
      <div class="img-modules">
        ...
        <div class="img-box">
          ...
          <p class="tips">图片建议尺寸600*450等比图片</p>
        </div>
      </div>
      <div class="prd-modules mt20">
        <div class="txt-btn">
          <input type="text" placeholder="套餐" class="txt-input" disabled="true">
          <span class="right">添加套餐+</span>
        </div>
        <div class="sel-box mt40">
          <!-- <span class="left-lab">服务亮点</span> -->
          <div class="right-lab">
            <div class="pos-rel">
              <span class="item-label">11111</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="cus-box"   v-if="isShowMask">
        ...
        <p class="control">
          ...
          <span class="right"  @click.stop="showMask">完成</span>
        </p>
        <div class="label-main">
          ...
          <div>
            <span class="add" @click="showAddTxt">+</span>
          </div>
        </div>
      </div>
      <div class="btn-bg">
...
export default {
  ...
  methods: {
    ...
    savePrice () {
      ...
      console.log('selectAllDate', this.selectAllDate)
      ...
      this.$http.post(this.API.guideDetail, {
        ...
        if (res.code === 0) {
          ...
          data.stockList.forEach((item) => {
            ...
            // this.value = [[2019, 10, 21], [2019, 10, 28]] 默认选中日期
