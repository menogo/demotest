<template>
  <div class="content-view">
    <div class="toolbar" @tap="format" v-if="showEditor">
      ...
      ></i>
      <i
        :class="['iconfont icon-723bianjiqi_duanhouju',formats.micon-predivarginBottom ? 'ql-active' : '']"
    ...
    insertImage() {
      wx.chooseImage({
        ...
        success: res => {
          ...
          const cloudPath =
            new Date().getTime() + "" + filePath.match(/\.[^.]+?$/)[0];
          wx.cloud.uploadFile({
            cloudPath,
            filePath,
            success: res => {
